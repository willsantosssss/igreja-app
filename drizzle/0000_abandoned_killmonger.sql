CREATE TYPE "public"."pix_type" AS ENUM('email', 'cpf', 'cnpj', 'telefone', 'aleatoria');--> statement-breakpoint
CREATE TYPE "public"."role" AS ENUM('user', 'admin');--> statement-breakpoint
CREATE TYPE "public"."status_batismo" AS ENUM('pendente', 'aprovado', 'rejeitado');--> statement-breakpoint
CREATE TYPE "public"."status_contribuicao" AS ENUM('pendente', 'confirmado', 'rejeitado');--> statement-breakpoint
CREATE TYPE "public"."status_inscricao" AS ENUM('confirmado', 'cancelado');--> statement-breakpoint
CREATE TABLE "anexos" (
...
CREATE TABLE "contribuicoes" (
	...
	"status" "status_contribuicao" DEFAULT 'pendente' NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE "inscricoesBatismo" (
	...
	"status" "status_batismo" DEFAULT 'pendente' NOT NULL,
...
CREATE TABLE "inscricoesEscolaCrescimento" (
	...
	"status" "status_inscricao" DEFAULT 'confirmado' NOT NULL,
	"createdAt" timestamp DEFAULT now() NOT NULL,
	"updatedAt" timestamp DEFAULT now() NOT NULL
);
--> statement-breakpoint
