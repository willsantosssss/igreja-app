...
export const appRouter = router({
  ...
  eventos: router({
    ...
    create: protectedProcedure
      .input(z.object({
        ...
        tipo: z.string().min(1),
        requireInscricao: z.number().min(0).max(1),
      }))
    ...
    update: protectedProcedure
      .input(z.object({
        ...
        data: z.object({
          ...
          requireInscricao: z.number().optional(),
        }),
      }))
      .mutation(({ input }) => db.updateEvento(input.id, input.data)),
    delete: protectedProcedure
      .input(z.number())
      .mutation(({ input }) => db.deleteEvento(input)),
  }),
  ...
  noticias: router({
    ...
    delete: protectedProcedure
      .input(z.number())
      .mutation(({ input }) => db.deleteNoticia(input)),
  }),
  ...
  aviso: router({
    ...
    update: protectedProcedure
      ...
      .mutation(({ input }) => db.updateAvisoImportante(input)),
  }),
