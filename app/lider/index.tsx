        ...
        <View className="gap-3 mt-4">
          ...
          >
            <View className="flex-row items-center gap-3 flex-1">
              ...
              <View className="flex-1">
                <Text className="text-base font-semibold text-foreground">Escola de Crescimento</Text>
                <Text className="text-xs text-muted">Inscritos na célula</Text>
              </View>
            </View>
            <IconSymbol name="chevron.right" size={20} color={colors.muted} />
          </TouchableOpacity>
          ...
          >
            <View className="flex-row items-center gap-3 flex-1">
              ...
              <View className="flex-1">
                <Text className="text-base font-semibold text-foreground">Anexos</Text>
                <Text className="text-xs text-muted">Documentos e guias</Text>
              </View>
            </View>
            <IconSymbol name="chevron.right" size={20} color={colors.muted} />
          </TouchableOpacity>
